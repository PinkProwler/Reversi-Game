...
public class Node
{
	// Move last - move used to reach this game, root nodes have a default Move object as last
	...
	// Positon is calculated by taking the amount of points acquired by Move last
	int position = 0;
